...
WORKDIR /src
COPY ["Gateway/API_Gateway/API_Gateway.csproj", "Gateway/API_Gateway/"]
RUN dotnet restore "./Gateway/API_Gateway/API_Gateway.csproj"
COPY . .
WORKDIR "/src/Gateway/API_Gateway"
